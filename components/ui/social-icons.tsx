...
export function GitlabIcon({ size = 16 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m22 13.3-2-7.3a1.3 1.3 0 0 0-.5-.7 1.2 1.2 0 0 0-.9-.2 1.2 1.2 0 0 0-.8.6L15.7 12H8.3L5.2 5.7a1.2 1.2 0 0 0-.8-.6 1.2 1.2 0 0 0-.9.2 1.3 1.3 0 0 0-.5.7l-2 7.3a1.3 1.3 0 0 0 .5 1.4L12 21l9.5-6.3a1.3 1.3 0 0 0 .5-1.4Z"/></svg>;
}
